...
- Het claimen van een airdrop met meer dan 2 personen tegelijkertijd. (Straf categorie 2)
...
- Het verlaten van de stad, nadat je karakter overleden is, wordt NIET gezien als combatloggen. Echter vervalt je recht op een revive als je ten onrechte dood gegaan bent.
...
- - Het aantal politie dat in dienst moet zijn voor de volgende overvallen zijn:
        * Grote Bank: 8 agenten nodig
        * Juwelier: 7 agenten nodig
        * Bank: 7 agenten nodig
        * Winkel: 4 agenten nodig.
        * ATM: 4 agenten nodig
        * House: 4 agenten nodig
...
- Het is verboden agenten te finishen wanneer deze in een minderheid zijn of als je makkelijk hun wapenriem zou kunnen afpakken of ze binnen de praatcirkels staan en je ze handen omhoog kan laten doen.
	- Een headshot valt ook onder finishen, als alleen het hoofdzichtbaar is en deze agent heeft al geschoten dan geldt dit niet.
	- Geef de agent die in zijn benen wordt geschoten de kans om of /e sit te doen of zijn handen omhoog te doen, dus niet meteen door schieten als je hem om hoog ziet komen.
	- als de agent achter of dicht bij een obstakel ligt (muur, auto etc. ) mag de agent wel opstaan en verder gaan.
	- als de agent te laag HP is en je dit niet KON weten, geldt dit niet.
	- als de agent laag HP heeft en zelf door blijft schieten, geldt dit niet.

- Een agent moet altijd gaan voor de arrestatie, er zijn hier net zoals tegen agenten uitzonderingen op:
	- wanneer zij in de minderheid zijn en je niet kunnen handsuppen vanwege de afstand.
	- Als alleen het hoofd zichtbaar is en de verdachte schiet wel, dan is dit eigen risico, dan valt dit onder noodweer.
	- als de speler te laag HP is en hun dit niet KONDEN weten, geldt dit niet
	- als de speler laag HP heeft en zelf door blijft schieten, dan geldt dit niet
	- als ze roepen handen omhoog als je beentjes bent geweest en je luistert niet.
